...
const AdminLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const menuItems = [
    ...
    { id: 'contacts', label: 'Contact Messages', icon: MessageCircle, path: '/admin/contacts' },
    { id: 'orders', label: 'Custom Requests', icon: ClipboardList, path: '/admin/orders' },
    ...
    <div className="flex h-screen bg-neutral-100">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-neutral-900 text-white transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${
        ...
        <div className="flex items-center justify-between p-6 border-b border-neutral-700">
          <Link href="/admin/dashboard" className="text-2xl font-serif font-bold">
            Furniture Admin
          </Link>
          <button
